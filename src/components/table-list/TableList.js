...
const TableList = ({ isLoading, tableInstance, filter }) => {
  ...
  const { data, hideControl, showFilter, toggleFilter } = tableInstance;
  ...
  //     manualPagination: !!pagination?.totalCount,
          ...
          <div>
            <Row className="mb-3">
              ...
              <Col sm="12" md="7" lg="9" xxl="10" className="text-end">
                ...
                <div className="d-inline-block">
                  <ControlsPageSize tableInstance={tableInstance} isLoading={isLoading} />
                </div>
              </Col>
            </Row>
            {filter && <>{filter}</>}
            ...
            >
              <Col xs="12" style={{ overflowX: 'auto' }}>
                ...
                {data.length === 0 && (
                  <Card>
                    <Card.Body className="my-3" style={{ textAlign: 'center' }}>
                      {f({ id: 'common.no-data' })}
                    </Card.Body>
                  </Card>
                )}
